...
handleParse :: TF.Result [PactExp] -> ([PactExp] -> Repl (Either String a)) -> Repl (Either String a)
...
parsedCompileEval :: String -> TF.Result [PactExp] -> Repl (Either String (Term Name))
