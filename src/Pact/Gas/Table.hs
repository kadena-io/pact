...
data GasCostConfig = GasCostConfig
  ...
  , _gasCostConfig_hyperlaneEncodeDecodeTokenMessageGasPerOneHundredBytes :: MilliGas
...
defaultGasConfig = GasCostConfig
  ...
  , _gasCostConfig_hyperlaneEncodeDecodeTokenMessageGasPerOneHundredBytes = MilliGas 50
...
tableGasModel gasConfig =
  let run name ga = case ga of
        ...
        GHyperlaneEncodeDecodeTokenMessage len ->
          let MilliGas costPerOneHundredBytes = _gasCostConfig_hyperlaneEncodeDecodeTokenMessageGasPerOneHundredBytes gasConfig
          in MilliGas (costPerOneHundredBytes * div (fromIntegral len) 100)
